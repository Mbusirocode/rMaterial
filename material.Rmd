...
## Why R for Data Management and Visualization? 
...
- Created by Ross Ihaka and Robert Gentleman in 1992
...
your computer. You can even begin to use the console.

- R studio has a 4 pane window, top left is the R code editor allowing you to create a file with multiple lines of R code.

- Bottom left is the interactive console where you can type in R statements one line at a time.

- The top right window shows your workspace which includes a list of objects currently in memory. There's also a history tab with a list of your prior commands.

- Bottom right shows a plot if you've created a data visualization with your R code.
...
## R Basics for data management and visualization.
...
- 18,773+ packages found on the CRAN
